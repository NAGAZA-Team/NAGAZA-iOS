...
final class SignUpExperienceSelectionViewController: UIViewController {
...
//        stackView.alignment = .leading
    ...
    @objc private func nextButtonTapped() {
        let vc = SignUpLevelSelectionViewController()
...
struct EscapeExperienceViewControllerPreview: PreviewProvider {
    static var previews: some View {
        let viewController = SignUpExperienceSelectionViewController()
