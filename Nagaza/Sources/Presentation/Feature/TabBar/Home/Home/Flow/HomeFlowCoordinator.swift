...
protocol HomeFlowCoordinaterDependencies {
    ...
    func makeRegionSettingFlowCoordinator(navigationController: UINavigationController) -> RegionSettingFlowCoordinator
}
...
final class HomeFlowCoordinator: Coordinator {
    ...
    private func showRegionSetting(
        ...
        let coordinator = dependencies.makeRegionSettingFlowCoordinator(navigationController: navigationController)
        
        coordinator.start(with: subRegion, didSelect: didSelect)
